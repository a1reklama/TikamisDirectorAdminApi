...
| plate                | Номер автомобиля. Будет null, если тип блока "free"                                                                    |
...
| carCenter            | Автосервис, к которому прикреплён пост, к которому относится пост в элементе. Для директора всегда будет одно значение |
